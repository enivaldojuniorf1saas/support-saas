        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12 relative">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="password" className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Senha de Acesso</label>
                        <input
                            id="password"
                            type="password"
                            disabled={isSubmitting}
                    ...
                    <div className="space-y-3 pt-4 border-t border-gray-100 mt-6">
                        <button type="submit" disabled={isSubmitting} className="w-full bg-blue-600 text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-blue-700 active:bg-blue-800 disabled:opacity-50 transition-all shadow-sm cursor-pointer">
                        ...
                        <Link to="/rastrear" className="w-full flex items-center justify-center bg-sky-50 hover:bg-sky-100 text-blue-600 py-2.5 rounded-xl font-semibold text-sm transition-all shadow-xs">
                            Rastrear Código de Chamado
                        </Link>

                        <div className="text-center pt-1">
                            <Link to="/ResetPassword" className="text-xs font-semibold text-gray-500 hover:text-blue-600 transition-colors">
                ...
                {/* 🚀 APONTA PARA A NOVA ROTA PÚBLICA (/ajuda) */}
                <div className="text-center pt-6 mt-6 border-t border-gray-200 dark:border-gray-800">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Precisa de ajuda com o sistema?</p>
                    <button
                        onClick={() => navigate('/ajuda')}
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors w-full justify-center sm:w-auto cursor-pointer"
                    >
